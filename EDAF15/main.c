...
unsigned long long TomKva_v2(char* aname, char* cname, int seconds);
unsigned long long TomKva_v3(char* aname, char* cname, int seconds);
unsigned long long TomKva_v4(char* aname, char* cname, int seconds);
